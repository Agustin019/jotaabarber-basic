...
export default function Testimonios() {
    ...
    return (
       <section id='testimonios' className='pt-20 min-h-[90vh] mx-auto  '>
        <article className=' bg-barber bg-cover bg-center'>
             <div  className=' bg-black/60 h-auto p-9 md:px-16   relative text-blanco'>
                 ...
                 <Slider {...settings}>
                     <div className='py-8 md:px-5 font-OpenSans'>
                     ...
                     <div className='py-8 font-OpenSans'>
    ...
    return (
        <div className='h-full z-10 flex-col content-center justify-end relative hidden md:flex'>
            ...
            <img
                ...
                src="https://i.ibb.co/Y8Ytq67/arrow-circle-left-2.png" alt=""
    ...
    return (
        <div className='h-full z-10 hidden md:flex flex-col content-center justify-end relative'>
            ...
            <img
                ...
                src="https://i.ibb.co/K9FQ5Xz/arrow-circle-right-1.png" alt=''
            />
        </div>
    );
};
