...
export default function Testimonios() {
    ...
    return (
        <section className='mx-auto my-32 bg-[#D9D9D9] p-9 md:p-16 relative'>
            <h2 className='font-semibold text-[32px] md:text-5xl text-center my-5'>¿Qué dicen nuestros <br /> clientes?</h2>
